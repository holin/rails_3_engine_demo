...
Gem::Specification.new do |s|
  ...
  s.files = [
    ...
    "lib/rails/generators/cheese/templates/oauth/qq.yml",
    "lib/rails/generators/cheese/templates/oauth/sina.yml",
